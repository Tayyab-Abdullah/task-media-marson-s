...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  return (
    <>
      {/* Desktop Sidebar */}
      <aside className="hidden md:flex flex-col w-[240px] shrink-0 bg-linear-to-b from-primary-blue to-primary-blue-dark rounded-[32px] !p-6 !my-4 !ml-4 !mr-0 self-start sticky top-4 shadow-premium overflow-y-auto custom-scrollbar h-[calc(100vh-120px)]">
        <SidebarContent />
      </aside>
